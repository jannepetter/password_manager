...
class UpdateWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        labels = ["Description","Username","Current Password:", "New Password:", "Confirm Password:"]
        self.entries = []
        ...
        submit_button.pack(side=tk.LEFT, padx=7, pady=12)

        # Cancel button
        cancel_button = ttk.Button(self, text="Cancel", command=self.destroy)
        cancel_button.pack(side=tk.RIGHT, padx=7, pady=12)
