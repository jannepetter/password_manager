...
class TestDB(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.iterations_patcher = patch('src.handle_data.KEY_ITERATIONS', new=1)
    ...
    def test_encrypt_decrypt(self):
        ...
        encrypted_text = _encrypt(plain_text,self.key,"static_vector111".encode())
        self.assertEqual(
            "LqmqHlr5Nu6+ra6owJoPuCqHelEuOXMxQxe5Zis013s=",
            encrypted_text
        )
        decrypted_text = _decrypt(encrypted_text,self.key,"static_vector111".encode())
        self.assertEqual(
            "some_message",
            decrypted_text
        )
    ...
    def test_init_vector(self):
        ...
        plain_text="some_message"
        encrypted_text = _encrypt(plain_text,self.key,"static_vector111".encode())
        encrypted_text2 = _encrypt(plain_text,self.key,"static_vector112".encode())
        ...
        self.assertEqual(
            "WBU8MSRrRjtzJcn1Zs8aGTEn/KcWMtEgFxSgP0hcm74=",
            encrypted_text2
        )
